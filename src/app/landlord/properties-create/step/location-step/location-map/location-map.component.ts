...
export class LocationMapComponent {
  ...
  layersControl = {
    ...
    overlays: {
      ...
      "Big square, [46.8, -121.55]": polygon([[46.8, -121.55], [46.8, -121.55], [46.8, -121.55]])
    }
  }
  ...
  search(newCompleteEvent: AutoCompleteCompleteEvent): void {
    this.filteredCountries = this.countries.filter(country => country.name.common.toLowerCase()
      .startsWith(newCompleteEvent.query))
  }
}
